...
namespace IO.SprintPay.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "SprintPay-Codegen/1.0.0/csharp";
            BasePath = "http://197.159.2.146:7086/sprintpayapi";
        ...
        public Configuration(
            ...
            string basePath = "http://197.159.2.146:7086/sprintpayapi") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "SprintPay-Codegen/1.0.0/csharp"
        ...
        public virtual string TempFolderPath
        {
            ...
            set
            {
                ...
                {
                    // Possible breaking change since SprintPay-codegen 2.2.1, enforce a valid temporary path on set.
        ...
        {
            String report = "C# SDK (IO.SprintPay) Debug Report:\n";
